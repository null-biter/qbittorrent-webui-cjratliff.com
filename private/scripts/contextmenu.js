    ...
    const TorrentsTableContextMenu = new Class({
        ...
        updateCategoriesSubMenu: function(category_list) {
            ...
            categoryList.appendChild(new Element('li', {
                html: '<a href="javascript:torrentNewCategoryFN();"><img src="images/list-add.svg" alt="Nova..."/> Nova...</a>'
            }));
            categoryList.appendChild(new Element('li', {
                html: '<a href="javascript:torrentSetCategoryFN(0);"><img src="images/edit-clear.svg" alt="Resetar"/> Resetar</a>'
            }));
        ...
        updateTagsSubMenu: function(tagList) {
            ...
            contextTagList.appendChild(new Element('li', {
                html: '<a href="javascript:torrentAddTagsFN();">'
                    + '<img src="images/list-add.svg" alt="Adicionar..."/>'
                    + ' Add...'
                    + '</a>'
            }));
            contextTagList.appendChild(new Element('li', {
                html: '<a href="javascript:torrentRemoveAllTagsFN();">'
                    + '<img src="images/edit-clear.svg" alt="Remover tudo"/>'
                    + ' Remove All'
                    + '</a>'
            }));
        ...
        updateMenuItems: function() {
            const enabledColumnIndex = function(text) {
                ...
                for (let i = 0; i < columns.length; ++i)
                    if (columns[i].get("html") === "Ativado")
                        return i;
            };

            this.showItem('Ativado');
            this.setItemChecked('Ativado', this.options.element.getChildren("td")[enabledColumnIndex()].get("html") === "Sim");

            this.showItem('Desinstalar');
        }
    });
